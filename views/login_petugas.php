...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="../assets_style/assets/dist/css/AdminLTE.min.css">
  <link rel="stylesheet" href="../assets_style/assets/dist/css/responsivelogin.css">
...
<body class="hold-transition login-page" style="overflow-y: hidden;background-color: #798E82; ">
<div class="login-box">
	<br/>
  ...
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #42775A; background-color: #42775A; box-shadow: 0px 0px 5px black;">
    ...
    <form action="dashboard_view.php" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="loding" class="btn btn-primary btn-block btn-flat" style="background-color: #C35045;">Sign In</button>
  ...
  <br/>
  <footer>
    <!-- <div class="login-box-body text-center" style="background-color: #42775A;">
...
<!-- Bootstrap 3.3.7 -->
<script src="../assets_style/assets/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="../assets_style/assets/plugins/iCheck/icheck.min.js"></script>
</body>
</html>
